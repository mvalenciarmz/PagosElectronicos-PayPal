  ...
  <h1>Welcome to <?php echo $company;?> PayPal Terminal</h1>
    ...
    <div id="form-content">
        <p>
            ...
            <input name="description" id="description" type="text"  value="<?php echo $item_description;?>" onkeyup="checkFieldBack(this);" />
        </p>
        <div class="clear"></div>
        <p>
            <label>Amount:</label>
            <input name="amount" id="amount" type="text"  onkeyup="checkFieldBack(this);noAlpha(this);" onkeypress="noAlpha(this);" />
        </p>
        <div class="clear"></div>
        <p>
